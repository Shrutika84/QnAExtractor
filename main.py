...
def main(pdf_path):
    """Main function to generate Q&A from a PDF."""
...
if __name__ == "__main__":
    pdf_path = r"C:\Users\shrut\Documents\LLM\QnAGenerator\QnA System\data\Lecture_notes_module_3.pdf"  # Change this to your actual PDF path
    main(pdf_path)
